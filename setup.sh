...
# The script expects the weights to be in 'local_repo/Infinity/'.
echo " Creating directory for model weights..."
mkdir -p local_repo/Infinity
...
wget -c -O local_repo/Infinity/infinity_2b_reg.pth https://huggingface.co/FoundationVision/Infinity-2B/resolve/main/infinity_2b_reg.pth

echo " Downloading Infinity VAE weights (158 MB)..."
wget -c -O local_repo/Infinity/infinity_vae_d32reg.pth https://huggingface.co/FoundationVision/Infinity-2B/resolve/main/infinity_vae_d32reg.pth
